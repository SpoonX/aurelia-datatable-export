define(['exports', 'aurelia-templating', 'aurelia-pal', 'aurelia-view-manager', 'json2csv', 'js2xmlparser'], function (exports, _aureliaTemplating, _aureliaPal, _aureliaViewManager, _json2csv, _js2xmlparser) {
  'use strict';
